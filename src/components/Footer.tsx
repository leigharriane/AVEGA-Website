...
export default function Footer() {
  return (
    <footer
      id="fixedFooter"
      className="
        fixed bottom-0 left-0 right-0 -z-20 bg-white border-top-black border-[0.5px]"
    >
      <div className="px-20 pt-20 w-full">
        <div className="w-full flex flex-row items-start justify-between text-black rounded-none">
          ...
          <div className="flex flex-row items-start w-full max-w-[820px] justify-between gap-[2.5rem] font-medium text-base transition-all duration-300">
      ...
      <div className="text-lightestGray font-bold text-[15.5vw] max-h-[230px]">AVEGA BROS. </div>
    </footer>
  );
}
